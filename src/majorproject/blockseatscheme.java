 ...
 */
public class blockseatscheme extends javax.swing.JFrame
{
    int k=0;
    int str=0;
    int[] seat;
    ...
    private void initComponents()
    {
        ...
        jLabel12.setText("SCHEME WISE SEATING ARRANGEMENT ");
        ...
        jLabel15.setBounds(10, 10, 60, 30);
        ...
        jLabel13.setBounds(240, 10, 50, 30);
        ...
        jButton1.setBounds(290, 60, 90, 30);
        ...
        jButton3.setBounds(420, 60, 90, 30);
        ...
        jButton2.setBounds(540, 60, 120, 30);
        ...
        jPanel5.add(jLabel9);
        jLabel9.setBounds(490, 10, 60, 30);
        ...
        jButton4.setBounds(10, 60, 110, 30);
        ...
        jPanel5.add(t2);
        t2.setBounds(290, 10, 150, 30);

        jPanel2.add(jPanel5);
        jPanel5.setBounds(10, 60, 680, 100);
            ...
            for(int i=0;i<seat.length;i++)
            {
                ...
                while(rs79.next())
                {
                    ...
                    if(rs79.getString("scheme").equals(jComboBox2.getSelectedItem().toString()))
                    {
                        if(c<25)
                        {
                            model.addRow(new Object[]{c+1,seat[i]});
                            c++;
                        }
                        else
                        {
                            model1.addRow(new Object[]{(c+c1)+1,seat[i]});
                            c1++;
                        }
